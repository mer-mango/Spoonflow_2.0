          ...
          {activeTab === 'interactions' && (
            <div className="rounded-xl border border-dashed border-[var(--border)] bg-white p-8 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-[var(--muted)]">
                This tab will eventually auto-populate from Google Calendar meetings, Fathom notes,
                and post-meeting debriefs.
              </p>
            </div>
          )}
            ...
            <div className="space-y-3">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-[var(--muted)]">
                    Tasks linked to this contact. This will share data with the Tasks page.
                  </p>
                </div>

                <button
                  type="button"
                  className="rounded-lg bg-[rgba(193,152,173,0.18)] px-3 py-2 text-xs font-semibold text-[#9f6e89]"
                >
                  + New Task
                </button>
              </div>
