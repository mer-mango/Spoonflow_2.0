    ...
    <header className="border-b-[0.5px] border-[var(--border)] bg-white">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <p className="min-w-[140px] text-center text-base font-semibold text-[var(--text)]">
            ...
            <button
              type="button"
              className="ml-2 rounded-lg border border-[var(--border)] bg-white px-4 py-2 text-sm hover:bg-black/[0.03]"
              onClick={() => {
            ...
            <button
              type="button"
              className="rounded-lg bg-[var(--meeting)] px-4 py-2 text-sm font-medium text-white"
